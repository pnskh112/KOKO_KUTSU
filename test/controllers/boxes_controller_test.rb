...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post boxes_url, params: { box: { admin_id: @box.admin_id, max_side: @box.max_side, max_vertical: @box.max_vertical, name: @box.name, user_id: @box.user_id } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { admin_id: @box.admin_id, max_side: @box.max_side, max_vertical: @box.max_vertical, name: @box.name, user_id: @box.user_id } }
